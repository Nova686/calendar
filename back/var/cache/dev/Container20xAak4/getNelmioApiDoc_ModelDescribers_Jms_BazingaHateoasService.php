...
class getNelmioApiDoc_ModelDescribers_Jms_BazingaHateoasService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/nelmio/api-doc-bundle/src/ModelDescriber/BazingaHateoasModelDescriber.php';
        ...
        return $container->privates['nelmio_api_doc.model_describers.jms.bazinga_hateoas'] = new \Nelmio\ApiDocBundle\ModelDescriber\BazingaHateoasModelDescriber(($container->privates['hateoas.configuration.metadata_factory'] ?? $container->load('getHateoas_Configuration_MetadataFactoryService')), new \Nelmio\ApiDocBundle\ModelDescriber\JMSModelDescriber(($container->privates['jms_serializer.traceable_metadata_factory'] ?? $container->load('getJmsSerializer_TraceableMetadataFactoryService')), ($container->privates['annotations.reader'] ?? $container->load('getAnnotations_ReaderService')), ['json'], NULL, false, ($container->services['jms_serializer.serialization_context_factory'] ??= new \JMS\SerializerBundle\ContextFactory\ConfiguredContextFactory())));
    }
}
