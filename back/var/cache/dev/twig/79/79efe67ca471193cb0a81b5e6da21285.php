...
class __TwigTemplate_7217aa9b0d60fb2523ccf0cfd4bc5e91 extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_runs(runs, mode) -%}
    ...
    {%- endif -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/panel.html.twig", "/home/no-pop-os/Bureau/fullstacks/back/vendor/jms/serializer-bundle/Resources/views/Collector/panel.html.twig");
    }
}
