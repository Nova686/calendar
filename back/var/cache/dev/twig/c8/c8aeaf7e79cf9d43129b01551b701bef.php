...
class __TwigTemplate_31cb560009e1da5a8598683d4253c6e9 extends Template
{
    private $source;
    private $macros = [];
...
{%- macro render_table_triggered_handlers(handlers) -%}
    ...
    {%- endfor -%}
{%- endmacro -%}
", "@JMSSerializer/Collector/handlers.html.twig", "/home/no-pop-os/Bureau/fullstacks/back/vendor/jms/serializer-bundle/Resources/views/Collector/handlers.html.twig");
    }
}
